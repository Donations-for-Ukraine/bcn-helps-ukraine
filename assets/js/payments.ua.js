...
const bankPaymentInfo = `<div class="paymentInfo">
  <div>Реквізити для SEPA або SWIFT переказу:</div>
  <div>${'IB'}AN: ${'ES39'} ${'1563'} ${'2626'} ${'3232'} ${'6916'} ${'2693'}</div>
  <div>BIC: ${'NTSBE'}${'SM1XXX'}</div>
  <div>N${'am'}e: ${'Dmy'}t${'ro'} Za${'iet'}s</div>
</div>`
const cardPaymentInfo = `<div class="paymentInfo">Пройдіть за посиланням щоб скористатися карткою, Apple Pay or Google Pay: <a href="https://send.monobank.ua/jar/5XYsUEYyAJ">https://send.monobank.ua/jar/5XYsUEYyAJ</a></div>`
const paypalPaymentInfo = `<div class="paymentInfo">Пройдіть за посиланням щоб скористатися PayPal: <a href="https://www.paypal.me/dmitryzaets">https://www.paypal.me/dmitryzaets</a></div>`
