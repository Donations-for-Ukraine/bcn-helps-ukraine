...
const bankPaymentInfo = `<div class="paymentInfo">
  <div>Información de la cuenta para donar por transferencia SEPA o SWIFT:</div>
  <div>${'IB'}AN: ${'ES39'} ${'1563'} ${'2626'} ${'3232'} ${'6916'} ${'2693'}</div>
  <div>BIC: ${'NTSBE'}${'SM1XXX'}</div>
  <div>N${'am'}e: ${'Dmy'}t${'ro'} Za${'iet'}s</div>
</div>`
const cardPaymentInfo = `<div class="paymentInfo">Sigue el enlace para donar con tarjeta, Apple Pay o Google Pay: <a href="https://send.monobank.ua/jar/5XYsUEYyAJ">https://send.monobank.ua/jar/5XYsUEYyAJ</a></div>`
